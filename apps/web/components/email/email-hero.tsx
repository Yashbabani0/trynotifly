    ...
    <section className="relative overflow-hidden border-b bg-background py-24 sm:py-32">
      <div className="mx-auto max-w-6xl px-4 text-center sm:px-6 lg:px-8">
        ...
        <h1 className="text-4xl font-semibold tracking-tight sm:text-6xl">
          Email API for transactional notifications
        </h1>

        <p className="mx-auto mt-6 max-w-2xl text-base leading-7 text-muted-foreground sm:text-lg">
          Send OTPs, password resets, invoices, order updates, account alerts,
          and product notifications from one reliable Email API.
        </p>

        <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row">
          <Button asChild>
            <Link href="/pricing">Start sending emails</Link>
          </Button>
